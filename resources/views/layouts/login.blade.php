                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                            ...
                            <div class="text-center mb-11">
                                ...
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                                <div class="text-gray-500 fw-semibold fs-6">Inventaris</div>
                                <!--end::Subtitle=-->
                            </div>
                            <!--begin::Heading-->
                            <!--begin::Input group=-->
                            ...
                            <div class="d-grid mb-10">
                                <button type="submit" id="kt_sign_in_submit" class="btn btn-primary">
                                    ...
                                    <span class="indicator-progress">Tunggu Sebentar yaa...
                                        <span
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        document.getElementById("kt_sign_in_form").addEventListener("submit", function(event) {
            ...
            // Simulasi proses login (gantilah dengan validasi backend jika diperlukan)
